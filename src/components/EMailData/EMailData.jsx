            ...
            <div className="w-[100vw] p-0 m-0 h-[100vh]">
                  ...
                  <div className="bg-[#cccdcf] absolute h-[81vh] w-[83.8vw] top-[19vh] left-[16.2vw]">
                        ...
                        <div className="bg-white mt-6 ml-[8vw] h-[46vh] w-[64vw] rounded-2xl">
                              ...
                              <div className=' overflow-auto h-[34.7vh] ml-[6vw] space-y-[1vh] mt-[2vh]  '>
                                    <div className='flex flex-row'>
                                          <p className='px-[4vw] text-[2.65vh]'>This is your data from this _______ Email, which will be analyzed</p>  <p className='px-16 text-red-500 text-2xl'>X</p>
                                    </div>
                                    <div className='flex flex-row'>
                                          <p className='px-[4vw] text-[2.65vh]'>This is your data from this _______ Email, which will be analyzed</p>  <p className='px-16 text-red-500 text-2xl'>X</p>
                                    </div>
